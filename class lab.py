class Hotel:
    def __init__(self,budget = 0 ,   name = " Unnamed Hotel", visitors_per_year = 0, number_of_rooms = 0 , owner_name = " Unknown owner " ,year_of_creation = 0 ):
    ...
    def main(self):
       ...
       print(hotel1,hotel2,hotel3.___str___())
